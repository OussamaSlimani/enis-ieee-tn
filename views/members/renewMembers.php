...
<div class="container-fluid pt-4 px-4">
     <div class="bg-light rounded-top p-4">
          <div class="row align-items-center">
               <div class="col-9">
                    <h4 class="fw-semibold mb-8">Renew Membership</h4>
...
<div class="container-fluid pt-4 px-4">
     <div class="bg-light text-center rounded p-4">
          ...
          <div class="d-flex align-items-center justify-content-end mb-4">
               <div class="m-3">
                    <form class="ms-4 d-flex" action="search_renew_member" method="POST">
               ...
               <table class="table text-start align-middle table-bordered table-hover mb-0">
                    <thead>
                         <tr class="text-dark">
                              ...
                              <th scope="col">End Membership</th>
                         ...
                         <?php if (!empty($currentMembers)) : ?>
                              <?php foreach ($currentMembers as $member) : ?>
                                   <tr>
                                        ...
                                        <td><?php echo htmlspecialchars($member['EndMembership']); ?></td>
                                        <td class="td-actions text-right">
                                             <a href="index.php?url=payment_renew_member&code=<?php echo htmlspecialchars($member['MemberId']); ?>">
                                                  <i class="text-success fa fa-check me-2" style="font-size: 18px; padding-right : 4px;"></i>
                                             </a>
                                             <a href="index.php?url=delete_renew_member&code=<?php echo htmlspecialchars($member['MemberId']); ?>">
                         ...
                         <ul class="pagination justify-content-center mt-4">
                              <?php for ($i = 1; $i <= $totalPages; $i++) : ?>
                                   <li class="page-item <?php if ($i == $page) echo 'active'; ?>">
                                        <a class="page-link" href="index.php?url=renew_members&page=<?php echo $i; ?>"><?php echo $i; ?></a>
                                   </li>
                              <?php endfor; ?>
                         </ul>
                    </nav>
